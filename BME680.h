...
#define REG_GAS_WAIT_1	0x65		//	GAS_WAIT<5:0> ( DELAY BETWEEN HEAT AND MEASUREMENT IN ms ) , GAS_MULTIPLYER<7:6> ( GAS DELAY MULTIPLYER )
#define REG_GAS_WAIT_2	0x66		//	GAS_WAIT<5:0> ( DELAY BETWEEN HEAT AND MEASUREMENT IN ms ) , GAS_MULTIPLYER<7:6> ( GAS DELAY MULTIPLYER )
#define REG_GAS_WAIT_3	0x67		//	GAS_WAIT<5:0> ( DELAY BETWEEN HEAT AND MEASUREMENT IN ms ) , GAS_MULTIPLYER<7:6> ( GAS DELAY MULTIPLYER )
#define REG_GAS_WAIT_4	0x68		//	GAS_WAIT<5:0> ( DELAY BETWEEN HEAT AND MEASUREMENT IN ms ) , GAS_MULTIPLYER<7:6> ( GAS DELAY MULTIPLYER )
#define REG_GAS_WAIT_5	0x69		//	GAS_WAIT<5:0> ( DELAY BETWEEN HEAT AND MEASUREMENT IN ms ) , GAS_MULTIPLYER<7:6> ( GAS DELAY MULTIPLYER )
#define REG_GAS_WAIT_6	0x6A		//	GAS_WAIT<5:0> ( DELAY BETWEEN HEAT AND MEASUREMENT IN ms ) , GAS_MULTIPLYER<7:6> ( GAS DELAY MULTIPLYER )
#define REG_GAS_WAIT_7	0x6B		//	GAS_WAIT<5:0> ( DELAY BETWEEN HEAT AND MEASUREMENT IN ms ) , GAS_MULTIPLYER<7:6> ( GAS DELAY MULTIPLYER )
#define REG_GAS_WAIT_8	0x6C		//	GAS_WAIT<5:0> ( DELAY BETWEEN HEAT AND MEASUREMENT IN ms ) , GAS_MULTIPLYER<7:6> ( GAS DELAY MULTIPLYER )
#define REG_GAS_WAIT_9	0x6D		//	GAS_WAIT<5:0> ( DELAY BETWEEN HEAT AND MEASUREMENT IN ms ) , GAS_MULTIPLYER<7:6> ( GAS DELAY MULTIPLYER )
